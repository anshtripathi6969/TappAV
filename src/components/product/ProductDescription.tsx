        ...
        <section className="py-20 bg-background">
            <div className="container mx-auto px-4 max-w-[800px]">
                ...
                <div className="prose prose-invert prose-lg max-w-none text-gray-300 space-y-8">
                    ...
                    <h3 className="text-2xl font-semibold text-white mt-12 mb-4">Ideally Suited For</h3>
                    ...
                    <h3 className="text-2xl font-semibold text-white mt-12 mb-4">Installation flexibility</h3>
                    <p>
                    ...
                    <h3 className="text-2xl font-semibold text-white mt-12 mb-4">Gaming on the Big Screen</h3>
                    <p>
